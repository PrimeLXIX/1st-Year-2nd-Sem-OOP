...
class Account:
    ...
    def transfer(self, amount: float, receiver: 'Account'):
        if amount <= 0:
...
class SavingsAccount(Account):
    ...
    def __init__(self, account_number: str, user: User, amount: float, card: 'Card | None' = None):
...
class Card:
    def __init__(self, card_no: str, account: Account, pin: str):
...
class Bank:
    ...
    def search_account_from_card(self, card_no: str):
        for user in self.__users:
            for account in user.accounts:
                if account.card.card_no == card_no:
                    return account
                
    def search_account_from_account_no(self, account_no: str):
        for user in self.__users:
            for account in user.accounts:
...
user = {
    ...
    '1-1101-12345-13-0': [['Hermione Jean Granger', 'Saving', '0987654321', 2000, 'Debit', '12346', '1234'],['Hermione Jean Granger', 'Fix Deposit', '0987654322', 1000, '', '']],
